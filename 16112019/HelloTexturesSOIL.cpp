...
int main (int argc, char *argv[]) 
{
    ...
    SDL_Window* window = SDL_CreateWindow("Textures with SOIL", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 800, 600, SDL_WINDOW_OPENGL);
    ...
    glGenVertexArrays(1, &vao); glGenBuffers(1, &vbo); glGenBuffers(1, &ebo); glGenTextures(1, &tex);
   ...
   //  Position      Color             Texcoords
    ...
    int width, height;
    unsigned char *data = SOIL_load_image("img.png", &width, &height, 0, SOIL_LOAD_RGB);
