...
void display() 
{
	...
	mv_matrix = translate(0.0f, 0.0, -20.0f) *
         rotate(0.0f, 1.0f, 0.0f, f * 4.5f) * 
	 rotate(1.0, 0.0, 0.0, f * 2.1f) *
	 (0.0, 0.0, 1.0,  (float) glfwGetTime() * 0.01)* 
	...
	mv_matrix *= translate(cos(horizontal), -sin(horizontal), 0.0);
	mv_matrix *= translate(0.0, cos(vertical) * M_PI, sin(vertical));
	glUniformMatrix4fv(mvLoc, 1, GL_FALSE, mv_matrix);
...
int main (int argc, char** argv)
{
	...
	glfwSetKeyCallback(myWindow, processInput);
