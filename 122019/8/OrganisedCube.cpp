...
glm::mat4 modelTransform() 
{
    ...
    model = glm::rotate(model, glm::radians(10.0f * time), glm::vec3(0.0f, 0.0f, 1.0f));
    return model;
}
...
glm::mat4 projTransform(float WND_WIDTH, float WND_HEIGHT) 
{
...
int main() 
{
    ...
    while (true)
    {
        ...
        glm::mat4 proj = projTransform(800, 600);
        glUniformMatrix4fv(glGetUniformLocation(shaderProgram, "proj"), 1, GL_FALSE, glm::value_ptr(proj));

        glm::mat4 view = viewTransform();
